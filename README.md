...
1️⃣ Clone โปรเจกต์
bash
git clone https://github.com/yourusername/repair_queue_app.git
cd repair_queue_app
...
kotlin
package com.u675432100468.repair_app  // ต้องตรงกับ build.gradle
...
โครงการนี้เป็นส่วนหนึ่งของรายวิชา [ชื่อวิชา]
คณะ [คณะของคุณ] มหาวิทยาลัยเทคโนโลยีราชมงคลอีสาน
